                ...
                <div class="thmv-dash-subscribe_box">
                    <div class="thmv-dash-col-info">
                        ...
                        <form id="thmv_email_form" class="thmv_email_form" action="">
                            <input type="email" required placeholder="Email" value="<?= $mailChimpFieldValue ?>">
                    ...
                    <div class="thmv-dash-health-box">
                        ...
                        <div class="thmv-dash-col-premium">
                            ...
                            <div class="thmv-renew">
                                <form action="https://themeforest.net/item/bellevue-hotel-bed-breakfast-booking-theme/12482898" target="_blank" style="display: inline"><button type="submit" class="thmv-launch-setup">Renew</button></form>
                                <a href="https://help.bellevuetheme.com/article/262-extending-and-renewing-theme-support" target="_blank">How to renew</a>
                            </div>
                        </div>
                    </div>	
                </div>
