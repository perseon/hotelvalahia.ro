...
class AlohaPlugins {
    ...
    function init() {
        ...
        add_action('wp_ajax_get_activation_url', [self::getInstance(), 'getPluginActivationURL']);
    ...
    function loadAssets() {
        ...
        wp_localize_script('aloha-plugins-script', 'plugins_params', array(
            ...
            'activate_action' => 'get_activation_url',
    ...
    function getPluginUpdateURL() {
        ...
        wp_send_error(array('success' => false, 'message' => 'Error Updating'));
    }

    function getPluginActivationURL() {
        if (isset($_POST['slug'])) {
            $json = array(
                'url' => 'themes.php?page=tgmpa-install-plugins',
                'plugin' => array($_POST['slug']),
        ...
        wp_send_error(array('success' => false, 'message' => 'Error Activating'));
    }
    ...
    function getAllPlugins() {
        ...
        if (!is_array(self::$plugins) && $plugin_list && count($plugin_list)) {
            ...
            foreach ($instance->plugins as $slug => $plugin) {
                ...
                if (isset($plugin_list[$slug]['version']) && !isset($plugin['cant_install']) && !$plugin_list[$slug]['install']) {
...
//            sort($plugins);
    ...
    function showMotoPressCookieOption() {
