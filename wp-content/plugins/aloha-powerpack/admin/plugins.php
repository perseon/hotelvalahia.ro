...
<div class="thmv-body">
    ...
    <?php
    $showMotoPressCookieOption = $pluginHelper->showMotoPressCookieOption();
    $motopressCookieOption = $pluginHelper->getMotoPressCookieOptionValue();
    ?>
    <?php if ($showMotoPressCookieOption): ?>
        <div class="thmv-dash-started-welcome">
