...
<div class="post-inner">
    <<?php echo esc_attr($settings['title_size']); ?> class="post-title"><a href="<?php esc_url(the_permalink()); ?>"><?php echo wp_kses_post(the_title()); ?></a></<?php echo esc_attr($settings['title_size']); ?>>
